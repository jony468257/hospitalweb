...
return [
    ...
    */
    ...
    |
    */
    'background_image' => env('TYRO_LOGIN_BACKGROUND_IMAGE', '/images/auth/karina-giihan.png'),
    ...
    */
    'pages' => [
        'login' => [
            'background_title' => env('TYRO_LOGIN_BG_TITLE', 'Experience Giihan'),
            'background_description' => env('TYRO_LOGIN_BG_DESCRIPTION', 'Sign in to access exclusive Kpop concert content and manage your tickets.'),
        ],
        'register' => [
