        ...
        <div class="form-card giihan-card">
            ...
            <form method="POST" action="{{ route('tyro-login.password.email') }}">
                ...
                <div class="form-group giihan-group">
                    ...
                    <input type="email" id="email" name="email" class="form-input giihan-input @error('email') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="email@example.com">
                    @error('email')
            ...
            <div class="form-footer giihan-footer">
                <p>
                    ...
                    <a href="{{ route('tyro-login.login') }}" class="form-link giihan-link">Back to Login</a>
                </p>
            </div>
        </div>
    </div>
