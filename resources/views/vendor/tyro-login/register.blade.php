        ...
        <div class="form-card giihan-card">
            ...
            <form method="POST" action="{{ route('tyro-login.register.submit') }}">
                ...
                <div class="form-group giihan-group">
                    <label for="name" class="form-label giihan-label">Name</label>
                    <input type="text" id="name" name="name" class="form-input giihan-input @error('name') is-invalid @enderror" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Enter your name">
                    @error('name')
                ...
                <div class="form-group giihan-group">
                    ...
                    <input type="email" id="email" name="email" class="form-input giihan-input @error('email') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="email" placeholder="email@example.com">
                    @error('email')
                    <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group giihan-group">
                    ...
                    <input type="password" id="password" name="password" class="form-input giihan-input @error('password') is-invalid @enderror" required autocomplete="new-password" placeholder="••••••••" minlength="{{ config('tyro-login.password.min_length', 8) }}">
                    @error('password')
                    <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group giihan-group">
                    <label for="password_confirmation" class="form-label giihan-label">Confirm Password</label>
                    <input type="password" id="password_confirmation" name="password_confirmation" class="form-input giihan-input @error('password_confirmation') is-invalid @enderror" required autocomplete="new-password" placeholder="••••••••">
                ...
                <div class="form-group giihan-group captcha-group">
                    <label for="captcha_answer" class="form-label giihan-label">{{ $captchaConfig['label'] ?? 'Security Check' }}</label>
                    <div class="captcha-container">
                        <span class="captcha-question">{{ $captchaQuestion }}</span>
                        <input type="number" id="captcha_answer" name="captcha_answer" class="form-input giihan-input captcha-input @error('captcha_answer') is-invalid @enderror" required autocomplete="off" placeholder="{{ $captchaConfig['placeholder'] ?? 'Answer' }}">
                    </div>
                ...
                <!-- Submit Button -->
                <button type="submit" class="btn btn-primary giihan-btn" style="margin-top: 1rem;">
                    Create account
                </button>
            </form>
            ...
            <div class="form-footer giihan-footer">
                <p>
                    ...
                    <a href="{{ route('tyro-login.login') }}" class="form-link giihan-link">Log in</a>
                </p>
            </div>
        </div>
    </div>
